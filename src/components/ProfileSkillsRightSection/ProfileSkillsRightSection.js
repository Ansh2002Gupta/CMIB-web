...
import styles from "./ProfileSkillsRightSection.module.scss";

const ProfileSkillsRightSection = ({
  currentFieldState,
  ...
  return (
    <div className={styles.outerContainerFlexCol}>
      <Typography className={styles.headerText}>Soft Skills</Typography>
...
ProfileSkillsRightSection.defaultProps = {
  currentFieldState: [],
  setCurrentFieldState: () => {},
  onChange: () => {},
  onClick: () => {},
...
ProfileSkillsRightSection.propTypes = {
...
export default ProfileSkillsRightSection;
