const locale = {
  ...
  "setupCentres.participationFees": "Participation Fees (INR)",
  "setupCentres.enterParticipationFees": "Enter Participation Fees (INR)",
  "setupCentres.feesError": "Please enter valid participation fees (INR)",
  ...
  "label.jobProfileCompetion":
    " of job profile has been completed by the Member.",
  ...
  "label.menu.workExperience": "Work Experience",
  "label.menu.skillTraining": "Skill Training",
  "label.menu.activities": "Activities",
  "label.menu.jobPreference": "Job Preferene",
  "label.personalDetails": "Personal Details",
  "label.correspondingAddress": "Corresponding Address",
  "label.permanentAddress": "Permanent Address",
  ...
  "label.state": "State",
  "label.city": "City",
  "label.pin_code": "Pin code",
  "label.mobile_no": "Mobile Number",
  "label.phone_no": "Phone Number",
  ...
  "label.scheduled_interviews": "Scheduled Interviews",
  "label.job_summary": "Job Summary",
  "label.approved_by_admin": "Approved by Admin",
  "label.responsibilities": "Responsibilities",
  "label.no_of_vacancy": "Number of Vacancies",
  "label.workMode": "Work Mode",
  "label.flexiHours": "Flexi Hours",
  "label.fullTimePartTime": "Full Time/Part Time",
  "label.jobStatus": "Job Status",
  "label.sort_profile_of_the_company": "Short Profile of the Company",
  "label.funtional_areas": "Functional Areas",
  ...
  "label.maximumSalaryAnnualCTC": "Minimum Salary (Annual CTC) (INR)",
  "label.maximumSalary": "Maximum Salary (INR)",
  ...
  "label.genderPreference": "Gender Preference",
  "label.categoryPreference": "Category Preference",
  "label.essentialQualification": "Essential Qualification",
  "label.desiredQualification": "Desired Qualification",
  "label.jobOpeningDate": "Job Opening Date",
  "label.jobClosingDate": "Job Closing Date",
  "label.salaryNegotiable": "Salary Negotiable",
  "label.minimumSalary": "Minimum Salary (Annual CTC)",
  "label.maximumSalary": "Maximum Salary",
  "label.numberOfVacancies": "Number of Vacancies",
  "label.modeOfWork": "Mode of Work",
  "label.flexiHours": "Flexi Hours",
  "label.fullPartTime": "Full Time/Part Time",
  "label.jobStatus": "Job Status",
  "status.0": "Inactive",
  "status.1": "Active",
  "toggle.0": "No",
